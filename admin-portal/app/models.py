...
class AppConfigModel(Base):
    ...
    seerr_base_url: Mapped[str | None] = mapped_column(String(2048), nullable=True)
    seerr_email: Mapped[str | None] = mapped_column(String(255), nullable=True)
    seerr_password_secret: Mapped[str | None] = mapped_column(String(4096), nullable=True)
...
class UserModel(Base):
    ...
    access_package: Mapped[str] = mapped_column(String(40), nullable=False, default="full_access")
    can_access_live_tv: Mapped[bool] = mapped_column(Boolean, nullable=False, default=True)
    can_access_vod: Mapped[bool] = mapped_column(Boolean, nullable=False, default=True)
    can_access_quaddemand: Mapped[bool] = mapped_column(Boolean, nullable=False, default=True)
    can_access_seerr: Mapped[bool] = mapped_column(Boolean, nullable=False, default=True)
